...
export default function SplashScreen({
  ...
  return (
    <>
      <div className="flex h-screen gap-y-3 flex-col items-center justify-center text-7xl text-primary font-extrabold">
        <p className={`${className}`} ref={ref} /><p className="text-xl text-text">
        "Ciao" 
        </p>
      </div>
    </>
